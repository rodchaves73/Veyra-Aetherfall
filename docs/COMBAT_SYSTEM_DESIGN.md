...
`rawDamage = atk * skillMultiplier`; mitigação usa `100 / (100 + def)`; modificador elemental aplica depois da mitigação; crítico aplica por último; dano mínimo é 1. Light e Dark se contra-atacam, Arcane é neutro/especial.

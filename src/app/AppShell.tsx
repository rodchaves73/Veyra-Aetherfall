...
export function AppShell({
  ...
  return (
    <div className="relative min-h-dvh overflow-x-hidden">
      ...
      <Topbar state={state} />
      <main className="va-scroll relative z-10 mx-auto min-h-[calc(100dvh-8rem)] w-full max-w-[430px] px-3 pb-[calc(env(safe-area-inset-bottom)+6.5rem)] pt-4 min-[390px]:px-4">
        {children}
      </main>
